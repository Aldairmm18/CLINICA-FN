...
public class ManageBasicSuppliesScreen implements FunctionalityScreen {
    private final VBox root;

    public ManageBasicSuppliesScreen(Role role, RoleFunctionality functionality, AppContext appContext, SceneNavigator navigator) {
        ...
        Button primaryAction = new Button("Actualizar insumo");
