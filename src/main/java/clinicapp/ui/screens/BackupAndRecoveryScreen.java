...
public class BackupAndRecoveryScreen implements FunctionalityScreen {
    private final VBox root;

    public BackupAndRecoveryScreen(Role role, RoleFunctionality functionality, AppContext appContext, SceneNavigator navigator) {
        ...
        Button primaryAction = new Button("Ejecutar respaldo");
