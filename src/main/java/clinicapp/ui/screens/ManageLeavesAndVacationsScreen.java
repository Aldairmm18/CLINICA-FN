...
public class ManageLeavesAndVacationsScreen implements FunctionalityScreen {
    private final VBox root;

    public ManageLeavesAndVacationsScreen(Role role, RoleFunctionality functionality, AppContext appContext, SceneNavigator navigator) {
        ...
        Button primaryAction = new Button("Gestionar permisos y vacaciones");
