...
public class GenerateAdministrativeReportsScreen implements FunctionalityScreen {
    private final VBox root;

    public GenerateAdministrativeReportsScreen(Role role, RoleFunctionality functionality, AppContext appContext, SceneNavigator navigator) {
        ...
        Button primaryAction = new Button("Generar reporte");
