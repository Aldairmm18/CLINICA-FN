...
public class RequestDiagnosticStudiesScreen implements FunctionalityScreen {
    private final VBox root;

    public RequestDiagnosticStudiesScreen(Role role, RoleFunctionality functionality, AppContext appContext, SceneNavigator navigator) {
        ...
        Button primaryAction = new Button("Solicitar estudio");
