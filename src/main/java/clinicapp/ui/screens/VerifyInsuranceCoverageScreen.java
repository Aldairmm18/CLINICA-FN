...
public class VerifyInsuranceCoverageScreen implements FunctionalityScreen {
    private final VBox root;

    public VerifyInsuranceCoverageScreen(Role role, RoleFunctionality functionality, AppContext appContext, SceneNavigator navigator) {
        ...
        Button primaryAction = new Button("Verificar cobertura");
