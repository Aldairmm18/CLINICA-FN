...
public class NursingSheetsRecordScreen implements FunctionalityScreen {
    private final VBox root;

    public NursingSheetsRecordScreen(Role role, RoleFunctionality functionality, AppContext appContext, SceneNavigator navigator) {
        ...
        Button primaryAction = new Button("Guardar hoja");
