...
public class IssueCertificatesScreen implements FunctionalityScreen {
    private final VBox root;

    public IssueCertificatesScreen(Role role, RoleFunctionality functionality, AppContext appContext, SceneNavigator navigator) {
        ...
        Button primaryAction = new Button("Emitir certificado");
