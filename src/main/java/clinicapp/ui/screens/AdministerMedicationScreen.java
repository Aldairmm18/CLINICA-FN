...
public class AdministerMedicationScreen implements FunctionalityScreen {
    private final VBox root;

    public AdministerMedicationScreen(Role role, RoleFunctionality functionality, AppContext appContext, SceneNavigator navigator) {
        ...
        Button primaryAction = new Button("Registrar medicación");
