...
public class ReferPatientsScreen implements FunctionalityScreen {
    private final VBox root;

    public ReferPatientsScreen(Role role, RoleFunctionality functionality, AppContext appContext, SceneNavigator navigator) {
        ...
        Button primaryAction = new Button("Derivar paciente");
