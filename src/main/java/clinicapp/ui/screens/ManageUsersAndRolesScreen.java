...
public class ManageUsersAndRolesScreen implements FunctionalityScreen {
    private final VBox root;

    public ManageUsersAndRolesScreen(Role role, RoleFunctionality functionality, AppContext appContext, SceneNavigator navigator) {
        ...
        Button primaryAction = new Button("Gestionar usuarios y roles");
