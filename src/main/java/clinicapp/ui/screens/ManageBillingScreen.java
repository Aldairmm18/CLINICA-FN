...
public class ManageBillingScreen implements FunctionalityScreen {
    private final VBox root;

    public ManageBillingScreen(Role role, RoleFunctionality functionality, AppContext appContext, SceneNavigator navigator) {
        ...
        Button primaryAction = new Button("Gestionar facturación");
