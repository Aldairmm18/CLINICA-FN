...
public class ManageShiftsAndSchedulesScreen implements FunctionalityScreen {
    private final VBox root;

    public ManageShiftsAndSchedulesScreen(Role role, RoleFunctionality functionality, AppContext appContext, SceneNavigator navigator) {
        ...
        Button primaryAction = new Button("Gestionar turnos y horarios");
