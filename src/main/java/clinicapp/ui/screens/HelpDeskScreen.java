...
public class HelpDeskScreen implements FunctionalityScreen {
    private final VBox root;

    public HelpDeskScreen(Role role, RoleFunctionality functionality, AppContext appContext, SceneNavigator navigator) {
        ...
        Button primaryAction = new Button("Registrar ticket");
